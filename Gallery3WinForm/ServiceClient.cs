...
namespace BoredGamesWindowsform
{
    public static class ServiceClient
    {
        ...
        {
            return await InsertOrUpdateAsync("", "http://localhost:60064/api/BoredGames/PostOrder", "POST");
        }
        ...
        internal async static Task<string> DeleteGamesAsync(clsAllGames prWork)
        {
            ...
            {
                HttpResponseMessage lcRespMessage = await lcHttpClient.DeleteAsync
                    ($"http://localhost:60064/api/BoredGames/DeleteGame?Name={prWork.Name}&PublisherName={prWork.PublisherName}");
        ...
        internal async static Task<string> DeleteOrderAsync(string prOrderID)
        {
            ...
            {
                HttpResponseMessage lcRespMessage = await lcHttpClient.DeleteAsync
                    ($"http://localhost:60064/api/BoredGames/DeleteOrder?OrderID=" + prOrderID);
